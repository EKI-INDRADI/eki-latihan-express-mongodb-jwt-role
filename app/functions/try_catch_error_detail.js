...
exports.try_catch_error_detail = async function (error) {
  if (typeof error === 'object') {
    ...
    console.log('\n====== Information functions -> try_catch_error_detail.js - SERVICE STILL RUNNING, ERROR NOT STOPPED (MESSAGE ONLY) ======')
    if (error.message) {
...
// const error_detail =  require('../functions/try_catch_error_detail')
